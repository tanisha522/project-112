...
{
    document.getElementById("update_emoji").innerHTML="&#128555";
}
...
if(results[0].label=="stressed")
{
    document.getElementById("update_emoji2").innerHTML="&#128555";
}
if(results[0].label=="surprised")
{
    document.getElementById("update_emoji2").innerHTML="&#128558";
}
}
}
